...
if (screen.width > 600) {
    printLetterByLetter(spanName, "", 200);
} else {
    spanName.innerHTML = "";
}
...
function createPrjContent(destination, cards, divImgId) {
    ...
    for (var i = 0; i < cards.length; i++) {
        ...
        cardImg.style.backgroundImage = 'url(../portfolio/img/' + cards[i].prjImgName + ')';
        console.log(cardImg);
...
var tempLinks = ['https://github.com/ouda-sadek/Tic-Tac-Toe/',
    'https://github.com/ouda-sadek/Fansite/',
    'https://github.com/dina-yahiaoui/portfolio/',
    
];

// All the images responding to the template link list 
var tempImgs = ['tic.jpg',
    'background1.jpg',
    'port.jpg',
